        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(session('success'))
                <div class="mb-8 animate-bounce">
                    <div class="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-4 rounded-3xl shadow-xl shadow-orange-200 flex items-center justify-between border-2 border-white">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="font-black uppercase italic text-sm tracking-tighter leading-none">Pendaftaran Berhasil</h4>
                                <p class="text-[11px] font-bold opacity-90 mt-1">{{ session('success') }}</p>
                            </div>
                        </div>
                        <button onclick="this.parentElement.parentElement.style.display='none'" class="text-white/50 hover:text-white transition-colors">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div class="flex flex-wrap justify-center gap-3">
                            ...
                            <div class="bg-red-500/20 backdrop-blur-sm border border-red-400/30 px-5 py-3 rounded-2xl text-center min-w-[140px]">
                                ...
                                <p class="text-lg font-black text-white tracking-tighter italic">TUTUP</p>
                                <p class="text-[8px] text-red-200 font-bold uppercase mt-1 italic">Emergency Only</p>
                            </div>
                        </div>
                    </div>
                </div>
